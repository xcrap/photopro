...
struct MoonEclipsesTab: View {
    ...
    var body: some View {
        VStack(spacing: Theme.spacingLG) {
            // Header row
            HStack {
                Label("Lunar Eclipses", systemImage: "moon.circle")
            ...
            if filtered.isEmpty {
                VStack(spacing: Theme.spacingSM) {
                    ...
                    Text("No lunar eclipses in the selected range")
                        .font(.subheadline)
                        .foregroundStyle(Theme.mutedForeground)
                }
    ...
    private func eclipseCard(_ eclipse: EclipseEvent) -> some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            // Row 2: Subtitle
            Text("\(eclipse.type.rawValue.capitalized) Lunar Eclipse · Peak \(eclipse.peakTime)")
                .font(.caption)
